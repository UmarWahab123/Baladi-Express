                    ...
                    <div class="row content-wrapper sidebar-right">
                        <div class="col-12 col-md-12 col-lg-12 content-primary">
                            <form name="checkout" method="post" class="checkout woocommerce-checkout"
                                action="https://klbtheme.com/machic/checkout/" enctype="multipart/form-data"
                                        ...
                                        <div class="col-1 shadow p-3 mb-4">
                                                    ...
                                                    <p class="form-row address-field validate-required validate-state form-row-wide"
                                                        ...
                                                        <label for="billing_state" class="">State&nbsp;<abbr
                                                            ...
                                                            class="woocommerce-input-wrapper"><select
                                                                ...
                                                                data-input-classes="" data-label="State" tabindex="-1"
                                                                aria-hidden="true">
                                                                ...
                                                                dir="rtl" style="width: 100%;"><span
                                                                    class="selection"><span
                                                                        ...
                                                                        role="combobox"><span
                                                                            ...
                                                                            role="textbox" aria-readonly="true"
                                                                            title="New York">New York</span><span
                                                                            class="select2-selection__arrow"
                                                                            role="presentation"><b
                                                                                role="presentation"></b></span></span></span><span
                                                                    class="dropdown-wrapper"
                                            ...
                                            <div class="woocommerce-account-fields">
                                                ...
                                                <div class="create-account" style="display: none;">
                                                    <p class="form-row validate-required" id="account_username_field"
                                                        data-priority=""><label for="account_username" class="">Account
                                                            username&nbsp;<abbr class="required"
                                                                title="required">*</abbr></label><span
                                                            class="woocommerce-input-wrapper"><input type="text"
                                                                class="input-text " name="account_username"
                                                                id="account_username" placeholder="Username"
                                                                value=""></span></p>
                                                ...
                                                <div id="shipping_address" class="shipping_address"
                                                    ...
                                                    <div class="woocommerce-shipping-fields__field-wrapper">
                                                            ...
                                                            id="shipping_country_field" data-priority="40"><label
                                                                ...
                                                                class="woocommerce-input-wrapper"><select
                                                                    ...
                                                                    dir="rtl" style="width: 100%;"><span
                                                                        ...
                                                                        country / region</button></noscript></span>
                                                        </p>
                                                        <p class="form-row address-field validate-required form-row-wide"
                                                        ...
                                                        <p class="form-row address-field validate-required validate-state form-row-wide"
                                                            ...
                                                            data-o_class="form-row form-row-wide address-field validate-required validate-state">
                                                            <label for="shipping_state" class="">State&nbsp;<abbr
                                                                    class="required"
                                                                    title="required">*</abbr></label><span
                                                                class="woocommerce-input-wrapper"><select
                                                ...
                                                <tbody>
                                                    <tr class="cart_item">
                                                        <td class="product-name">
                                                            Apple MWP22AM/A AirPods Pro&nbsp; <strong
                                                                class="product-quantity">×&nbsp;5</strong> </td>
                                                        <td class="product-total">
                                                            <span class="woocommerce-Price-amount amount"><bdi><span
                                                                        class="woocommerce-Price-currencySymbol">QAR
                                                                    </span>749.90</bdi></span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                            ...
                                                            <ul id="shipping_method"
                                                                ...
                                                                <li>
                                                                    <input type="radio" name="shipping_method[0]"
                                                                        ...
                                                                        class="shipping_method"><label
                                                                        for="shipping_method_0_local_pickup3">Local
                                                                        pickup</label>
                                                                </li>
                                                            </ul>
                                            ...
                                            <div id="payment" class="woocommerce-checkout-payment">
                                                <ul class="wc_payment_methods payment_methods methods">
                                                    ...
                                                    <li class="wc_payment_method payment_method_cheque">
                                                        ...
                                                        <div class="panel payment_box payment_method_cheque"
                                                            style="display:none;">
                                                    ...
                                                    <li class="wc_payment_method payment_method_cod">
                                                        ...
                                                        <div class="panel payment_box payment_method_cod"
                                                            style="display:none;">
                                                ...
                                                <div class="form-row place-order">
                                                    ...
                                                    <div class="woocommerce-terms-and-conditions-wrapper">
                                                        ...
                                                        <div class="woocommerce-terms-and-conditions"
                                                            ...
                                                            <ol>
                                                                <li>Ut enim ad minima veniam, quis nostrum
                                                                ...
                                                                <li>Quis autem vel eum iure reprehenderit qui in ea
                                                                    ...
                                                                    quo voluptas nulla pariatur</li>
                                                                <li>Et harum quidem rerum facilis est et expedita
                                                                    ...
                                                                    repellendus.</li>
                                                                <li>Temporibus autem quibusdam et aut officiis
                                                            ...
                                                            <p>All the Lorem Ipsum generators on the Internet tend
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>No one rejects, dislikes, or avoids pleasure
                                                        ...
                                                        <p class="form-row validate-required">
                                                            <label
                                                                ...
                                                                <span
                                                                    ...
                                                                    have read and agree to the website <a href=""
                                                    ...
                                                    <a href="reciept.php" type="" class="button alt" name="" id=""
                                                        value="Place order" data-value="Place order">Place
                                                        order</a>

                                                    <input type="hidden" id="woocommerce-process-checkout-nonce"
                                                        name="woocommerce-process-checkout-nonce"
                                                        value="810eb5aef0"><input type="hidden" name="_wp_http_referer"

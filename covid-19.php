        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="single_about_thumb mb-4">
                    <img src="https://html.dreamitsolution.net/corona/assets/images/about2.png" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="section_title left pb-4">
                    <div class="section_title_thumb rotateme">
                        <img src="https://html.dreamitsolution.net/corona/assets/images/lg.png" alt="">
                    </div>
                    <div class="section_title_content pt-20">
                        <h5>ABOUT COVID 19</h5>
                        <h2>Yet food supply chain in the devolved world have largely been remarkably Resilient to date
                        </h2>
                        <p>The most common symptoms of COVID-19 are fever, tiredness, and dry cough. Some patients may
                            have aches and pains, nasal forest congestion, runny nose, sore throat or diarrhea. </p>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section_title_content pt-2">
                    ...
                    <p>The most common symptoms of COVID-19 are fever, tiredness, and dry cough. Some patients may have
                        aches and pains, nasal congestion, runny nose, sore throat or diarrhea. These symptoms are
                        usually mild and begin gradually. Also the symptoms may appear 2-14 days after exposure.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                East Respiratory Syndrome (MERS) and Severe Acute Respiratory Syndrome (SARS) are two
                                other examples of coronaviruses that originated from animals and then spread to people.
                                More information about the source and spread of COVID-19 is available on the Situation
